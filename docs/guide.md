...
| ![img](https://github.com/user-attachments/assets/e0705024-3ccf-4e6d-9878-f43a0b9db977) |
| :---: |
| _Мастер спрашивает, есть ли маяк с известными координатами, который можно использовать как **опорный**_ |
...
| Азимут | Курс антенны (от компаса) |
 ...
 | ![img](https://github.com/user-attachments/assets/5170772b-6b3b-4f97-ab8d-524b85c73673) |
 | :---: |
 | _скриншот панели антенны с положением по опорному маяку и по GNSS_ |
...
- **Макс. скорость судна** (0.5–5 м/с, по умолчанию 2.0) — позиции, перемещение которых превышает эту скорость, отбрасываются.
...
| ![img](https://github.com/user-attachments/assets/197f5dfd-03f7-43f7-9651-9a4602b03952) |
| :---: |
| _Cкриншот карты с опорным маяком и траекторией судна, определяемой по опорному маяку |
