...
| <img width="2520" height="72" alt="image" src="https://github.com/user-attachments/assets/573ba1c1-aed5-45df-bc54-5381f81201a8" /> |
| :---: |
...
| 🔧 Инструменты | Выпадающее меню: топопривязка, POI, калибровки, DRMS |
| 📤 Экспорт | Выпадающее меню: CSV, GGA, PSIMSSB, KML |
| 📋 Лог | Выпадающее меню: сохранить, открыть, анализ, воспроизвести |

### Карта

| <img width="2520" height="1285" alt="image" src="https://github.com/user-attachments/assets/833f1d79-1b07-460e-a35d-8f4d45e3c769" /> |
| :---: |
| _Панель карты_ |
...
| <img width="489" height="282" alt="image" src="https://github.com/user-attachments/assets/f30a5af2-8570-4436-8f73-7228ab58c297" /> |
| :---: |
| _Панель маяков_ |
...
| <img width="269" height="311" alt="image" src="https://github.com/user-attachments/assets/50871575-090d-475d-9d02-a68dec3f1f74" /> |
| :---: |
| _Карточка антенны_ |
...
> **Важно:** Для калибровки φ нужен неподвижный маяк. Судно должно маневрировать так, чтобы маяк был виден под разными углами.
